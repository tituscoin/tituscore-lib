Contributing to Tituscore
=======

We're working hard to make *tituscore* the most powerful JavaScript library for working with titus coin. Our goal is to have *tituscore* be a library that can be used by anyone interested in titus coin, and to level expertise differences with great design and documentation.
...
These are some global design goals in tituscore that any change must adhere.
...
Avoid representation errors by always dealing with hugos. For conversion for frontends, use the `Unit` class.
...
Name them in PascalCase, as they are namespaces.
...
```sh
git remote add tituscoin git@github.com:tituscoin/tituscore.git
git pull --rebase tituscoin master
```
...
```
Finally go to [github.com/tituscoin/tituscore](https://github.com/tituscoin/tituscore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of tituscore.

If you have any questions feel free to post them to
[github.com/tituscoin/tituscore/issues](https://github.com/tituscoin/tituscore/issues).
